...
$descriptif = "";
if($_GET['num'] == 1){
  $val = GetCatDepenseById($_GET['id'],$bdd);
  $descriptif = $val[0]['descriptif'];
  $id = $_GET['id'];
}
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="../../traitement/admin/traitementAddCatDep.php" class="bg-light p-5 contact-form">
              <div class="form-group">
                <label for="Nom" class="label">Descriptif</label>
                <input type="text" class="form-control" placeholder="Descriptif" value="<?php echo $descriptif; ?>" name="descriptif">
              </div>
