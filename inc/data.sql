...
VALUES 
(1,1, '2023-07-10', 1, 15.75),
(2,1, '2023-07-12', 2, 20.00);
INSERT INTO The_ceuillir (idCeuil,idUser, daty, idParc, poids) 
VALUES 
(3,1, '2013-07-10', 1, 15.75),
(4,1, '2018-07-10', 1, 15.75),
(5,1, '2009-07-10', 1, 15.75),
(6,1, '2014-07-10', 1, 15.75);
INSERT INTO The_ceuillir (idCeuil,idUser, daty, idParc, poids) 
VALUES 
(7,1, '2013-07-10', 2, 15.75),
(8,1, '2018-07-10', 2, 15.75),
(9,1, '2009-07-10', 1, 15.75),
(10,1, '2014-07-10', 2, 15.75);

-- Insertion de données dans la table The_depenser
INSERT INTO The_depenser (idUser,idCatDep, montant, daty) 
VALUES 
(1,1, 250.75, '2023-07-15'),
(1,2, 120.00, '2023-07-20');
...
FROM 
    The_ceuillir
WHERE 
    daty BETWEEN "2013-07-07" AND "2023-07-07" 
GROUP BY 
...
okay! good!
now I want to make a function that takes that selection and maybe 
tranform it into a view, then add a last column which is called
reste , I am going to set each of the values for reste 
using my php function GetRendementParcelle($idParc,$bdd) in which idParc is my
the Parcelle and bdd my database which I already have from an argument in my function.
So how do I create that and set the reste ??
